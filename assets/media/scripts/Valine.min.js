	...
	, function(e, t, n) {
			...
			r.prototype._init = function() {
					...
					try {
							...
							e.el.innerHTML = '<div class="vwrap"><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + e.placeholder + '"></textarea><div class="vctrl"><span class="vemoji-btn">' + e.locale.ctrl.emoji + '</span> | <span class="vpreview-btn">' + e.locale.ctrl.preview + '</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-80"><div class="vheader item' + j.length + '">' + j.join("") + '</div></div><div class="col col-20 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + e.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v' + o + "</div></div>";
			...
			r.prototype.bind = function(e) {
					...
					var P = function() {
						...
						, I = function(e) {
							...
							}) : "" == g.comment ? void _.comment.focus() : (g.nick = g.nick || "Anonymous",
						...
						, Q = function() {
							...
							n.setACL(N()),
							n.save().then(function(e) {
									"Anonymous" != g.nick && x && x.setItem("ValineCache", JSON.stringify({
											nick: g.nick,
											link: g.link,
											mail: g.mail
									}));
